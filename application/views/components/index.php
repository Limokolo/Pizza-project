...
<html lang="en">
  ...
  <body>
    ...
    <div class="col-md-10 col-md-offset-1" style="margin-top: 40px;">
      ...
      <?php if(sizeof($components) > 0): ?>
        ...
        <?php foreach($components as $component): ?>
              <tr>
                  ...
                  <td><button class="btn btn-info info-button" data-id="<?=$component -> id?>">Pokaż</button></td>
              </tr>
        <?php endforeach; ?>
            </tbody>
          </table>
      ...
      <?php else: ?>
          <div class="alert alert-danger">Brak składników!</div>
      <?php endif; ?>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p class="component-name">
                Nazwa składnika: <strong></strong>
            </p>
            <p class="component-price">
                Cena składnika: <strong></strong> <strong>zł</strong>
            </p>
          </div>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="newModal">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title">Dodaj składnik</h4>
          </div>
          <div class="modal-body">

            <div class="alert alert-danger" role="alert" id="cannot_add_alert" style="display: none;">
                <strong>Uwaga!</strong> Nie udało się dodać składnika.
            </div>
            ...
            <div class="alert alert-warning" role="alert" id="component_exists_alert" style="display: none;">
                <strong>Uwaga!</strong> Składnik został już wcześniej dodany.
            </div>

            <form class="form-horizontal" id="add_component_form">
              <div class="form-group">
                <label for="name_input" class="col-sm-3 control-label">Nazwa składnika:</label>
                <div class="col-sm-9">
                  <input type="text" name="name" placeholder="Nazwa" class="form-control" id="name_input" />
                </div>
              </div>
              <div class="form-group">
                <label for="price_input" class="col-sm-3 control-label">Cena składnika:</label>
                <div class="col-sm-9">
                  <div class="input-group">
                    <input type="number" step="0.01" name="price" placeholder="Cena" class="form-control" id="price_input" />
